          ...
          <div class="row">
            <div class="col-md-6 px-3 pt-5 pb-3">
              <div class="input-container-main">
                <input id="itmFechaInicio" type="date" name="itmFechaInicio" autocomplete="off" class="input-form-main"  value="" placeholder="">
                <label style="width: 50%;" for="itmFechaInicio" class="label-form-main" style="">Fecha Inciar</label>
              </div>
            </div>
            <div class="col-md-6 px-3 pt-5 pb-3">
              <div class="input-container-main">
                <input id="itmFechaFin" type="date" name="itmFechaFin" autocomplete="off" class="input-form-main"  value="" placeholder="">
                <label style="width: 50%;" for="itmFechaFin" class="label-form-main" style="">Fecha Fin</label>
              </div>
            </div>
            <div class="col-md-12 px-3 pt-5 pb-3">
              <div class="input-container-main">
                <input id="itmInfo" type="text" name="itmInfo" autocomplete="off" class="input-form-main"  value="" placeholder="">
