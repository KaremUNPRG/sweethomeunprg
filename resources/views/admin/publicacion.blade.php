    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('app.realizarpublicacionproceso')}}" id="formProceso" method="post" class="row">
          ...
          <input type="hidden" name="itmCoordenada" id="itmCoordenada" value="">
          <input type="hidden" name="itmCaracteristicas" id="itmCaracteristicas" value="">
            ...
            <div class="col-md-6" style="padding:0px">
              <div class="col-md-12 px-3 pt-5 pb-3">
                <div class="input-container-main">
                  <input id="itmDescripcion" type="text" name="itmDescripcion" autocomplete="off" class="input-form-main"  value="" placeholder="">
                  <label for="itmDescripcion" class="label-form-main" style="">Descripción</label>
                </div>
              </div>
              <div class="col-md-12 px-3 pt-5 pb-3">
                <div class="input-container-main">
          ...
          <div class="col-md-4 px-3 pt-5 pb-3">
            <div class="input-container-main">
              <input id="itmDireccion" type="text" name="itmDireccion" autocomplete="off" class="input-form-main"  value="" placeholder="">
              <label for="itmDireccion" class="label-form-main" style="">Dirección</label>
            </div>
          </div>
          <div class="col-md-2 px-3 pt-5 pb-3">
            <div class="input-container-main">
              <input id="itmPrecio" type="number" name="itmPrecio" autocomplete="off" class="input-form-main"  value="" placeholder="">
              <label for="itmPrecio" class="label-form-main" style="">Precio</label>
            </div>
          </div>
          <div class="col-md-2 px-3 pt-5 pb-3">
            <div class="input-container-main">
              ...
              <div class="card-main-body row">
                <div class="col-md-12">
                  <div class="input-container-main input-container-group">
                    ...
                    <button type="button" id="agregarCaracteristica" name="button"><i class="fa fa-plus"></i></buttosn>
                  </div>
                </div>
...
@section('script')
  ...
  <script src="{{asset('backend/asset/js/publicacion.js')}}" charset="utf-8"></script>
