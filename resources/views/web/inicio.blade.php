              ...
              <div class="row" style="display: flex;flex-wrap: wrap;justify-content: center;">
                <div class="col-md-4">
                  <div class="aa-single-advance-search">
                    <input type="text" class="form-control" style="font-size: 14px" placeholder="Ingrese Localización">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="aa-single-advance-search">
                ...
                <div class="col-md-2">
                  <div class="aa-single-advance-search">
                    <input class="aa-search-btn btn-info btn"  type="button" style="font-size: 14px;font-weight: 100" value="Buscar">
                  </div>
                </div>
              </div>
            </div>
              ...
              {{-- <div class="col-md-4">
                <article class="aa-properties-item">
                  <a href="#" class="aa-properties-item-img">
                    <img src="{{asset('frontend/asset/img/Casa01.jpg')}}" alt="img">
                  </a>
