...
$(document).ready(function () {
    ...
    $('#table-body-venta tbody').on('click', 'td.details-control', function () {
    ...
    function format ( d ) {
        ...
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Comprobante:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.tipoDocumento_VNT+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Número:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.numeroDocumento_VNT+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Emisión:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.fechaEntrega_VNT+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Cliente:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.Nombre_CP+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Vendedor:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.nombre+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Estado:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+d.estado_VNT+'</td>'+
        '</tr>'+
        '<tr>'+
        '<td style="width: 10%;text-align: right;padding: 10px 10px;">Imprimir:</td>'+
        '<td style="text-align: left;padding: 10px 10px;">'+`<a href="/Venta/Vaucher/${d.codigo_VNT}/true" target="_black"><span class="small">
                                                    <button type="button" style="margin-top: -10px;" class="btn btn-info pb-small mb-0"><i class="fa fa-print" ></i></button>
                                                </span></a>`+'</td>'+
        '</tr>'+
        '</table>';
    }
